...
print(f"The semi-major axis is {round(a,2)} km")
print(f"The eccentricity is {round(e_scalar,3)}")
# print(f"The momentum vector is {h}")
print(f"The inclination is {round(i,1)} degrees")
print(f"The RAAN is {round(Omega,1)} degrees")
print(f"The argument of periapsis is {round(wobble_u,1)} degrees")
